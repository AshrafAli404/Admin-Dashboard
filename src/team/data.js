...
export const rows = [
    ...
    { id: 8, name: 'Rossini Frances', email: 'rossinifrances@gmail.com', age: 35, phone: '(222)444-5555', access: 'User' },
    { id: 9, name: 'Harvey Roxie', email: 'harveyroxie@gmail.com', age: 35, phone: '(444)555-6239', access: 'User' },
  ];
